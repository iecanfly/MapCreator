...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="<c:url value='/styles/lib/themeroller.css'/>" />
...
<body<decorator:getProperty property="body.id" writeEntireProperty="true"/><decorator:getProperty property="body.class" writeEntireProperty="true"/>>
    ...
    <div id="dafultOuterDivLv1" class="container-fluid">
        <%@ include file="/common/messages.jsp" %>
        <div id="dafultOuterDivLv2" class="row-fluid">
            <decorator:body/>
