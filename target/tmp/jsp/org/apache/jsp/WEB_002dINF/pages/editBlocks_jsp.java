...
public final class editBlocks_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      if (_jspx_meth_fmt_message_1(_jspx_page_context))
        return;
      out.write("</title>\n");
      out.write("    <meta name=\"menu\" content=\"EditBlockMenu\"/>\n");
      out.write("</head>\n");
      out.write("<body>\n");
      ...
      out.write("            <table id=\"editTable\" class=\"table\">\n");
      out.write("                <thead>\n");
      out.write("                    <tr>\n");
      out.write("                        <th>ID</th>\n");
      out.write("                        <th>Block</th>\n");
      out.write("                        <th>Number</th>\n");
      out.write("                        <th>Recommended Worker #</th>\n");
  ...
  private boolean _jspx_meth_fmt_message_1(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_1.setKey("editBlockMenu.title");
  ...
  private boolean _jspx_meth_c_forEach_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setVar("block");
    _jspx_th_c_forEach_0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${blockList}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\n");
          out.write("                    <tr id=\"tr");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${block.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">\n");
          out.write("                        <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${block.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\n");
          out.write("                        <td><input id=\"txtBlock");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${block.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" class=\"input-mini input-narrow\" type=\"text\" value=\"");
          ...
          out.write("\"></td>\n");
          out.write("                        <td><input id=\"txtNumber");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${block.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" class=\"input-mini input-narrow\" type=\"text\" value=\"");
          ...
          out.write("\"></td>\n");
          out.write("                        <td><input id=\"txtWorkerNum");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${block.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" class=\"input-mini input-narrow\" type=\"text\" value=\"");
          ...
          out.write("\"></td>\n");
          out.write("                        <td><button blockAttribute=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${block.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write(':');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${block.block}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write(':');
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${block.recommendedWorkerNum}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write(':');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${block.cong}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write(':');
          ...
          out.write("\" class=\"btnUpdate btn btn-small\" type=\"button\">Update</button></td>\n");
          out.write("                        <td><button blockAttribute=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${block.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" class=\"btnDelete btn btn-primary btn-small\" type=\"button\">Delete</button></td>\n");
          out.write("                    </tr>\n");
          out.write("                ");
  ...
  private boolean _jspx_meth_c_set_2(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_set_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("        new Territory.EditBlock();\n");
        out.write("    });\n");
        out.write("</script>\n");
